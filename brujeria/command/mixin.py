...
from ..utils import BuildInfo, _parse_cmd, _create_compile_rule, _create_target_rule
from ..ast import Ninja, Target
...
class BuildCommandMixin (ABC):
    ...
    def _compile (self, _, cmd):
        self.compile(_parse_cmd(cmd, self.parser))

    def _target (self, _, cmd):
        self.target(_parse_cmd(cmd, self.parser))
